...
class Router
{
    public function routes()
    {
        ...
        //On teste si la supperglobale $_GET['action'] est déclarée et non vide, puis on ajouter le premier index de $_GET dans la variable
